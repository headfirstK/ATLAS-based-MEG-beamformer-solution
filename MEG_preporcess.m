...
% This file is used to preprocess the raw MEG data.
...
%% Preprocess raw MEG data for each subject during each state
for i = 1:length(subjects)
    ...
    for j = 1:length(states)
        ...
        cfg.channel                 = {'MEGGRAD'};          % Only use gradient channel
        ...
        % Filt the data and remove line noise
        cfg.bsfilter        = 'yes';
